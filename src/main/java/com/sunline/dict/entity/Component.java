...
/**
 * 构件实体（对应 .pbcb/.pbcp/.pbcc/.pbct.xml 文件的 serviceType 标签）
 */
@TableName("component")
public class Component implements Serializable {
    ...
    /** 构件类型：pbcb / pbcp / pbcc / pbct（由文件后缀决定） */
    ...
    public String toString() {
        return "Component{id='" + id + "', longname='" + longname + "', componentType='" + componentType + "', fromJar='" + fromJar + "'}";
    }
}
